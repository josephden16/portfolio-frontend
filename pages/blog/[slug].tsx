  ...
  return (
    <Layout seo={seo} className="ml-3 mr-3 mb-10 lg:ml-24 lg:mr-24 xl:ml-36 xl:mr-36 lg:mt-6">
      <div className="mt-10 lg:mt-20 lg:w-5/6 xl:w-2/3 lg:m-auto">
        <h1 className="text-3xl lg:text-3xl m-auto font-bold mb-10">{article.title}</h1>
        {lastUpdated && <h3 className="mb-8 text-lg">Last updated: {lastUpdated}</h3>}
        <div className="mt-3 mb-12">
          <img src={imageURL} draggable={false} className="m-auto w-full lg:h-96" alt={article.image.alternativeText} />
        </div>
        <div className="mb-24">
          <div>
            <ReactMarkdown className="lg:text-lg leading-7 lg:leading-8" children={article.content} allowDangerousHtml={true} />
          </div>
        </div>
      </div>
